    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($query) {
                ...
                $deleteBtn = "<a href='" . route('admin.products.destroy', $query->id) . "' class='btn btn-danger ml-2
                delete-item'><i class='far fa-trash-alt'></i></a>";
                ...
                <div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; transform: translate3d(0px, 28px,
                ...
                <a class="dropdown-item has-icon" href="#"><i class="far fa-file"></i> Another</a>
            ...
            ->addColumn('type', function($query){
                ...
                case 'featured_product':
                    return '<i class="badge badge-warning">Featured Produk</i>';
                    break;
                case 'top_product':
            ...
            ->addColumn('status', function ($query) {
                    if ($query->status == 1) {
                        $button = '<label class="custom-swich mt-2">
