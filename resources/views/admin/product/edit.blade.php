                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    @foreach ($categories as $category)
                                       <option {{ $category->id == $product->category_id ? 'selected' : ''}} value="
                                ...
                                <div class="col-md-4">
                                    ...
                                    <option {{ $subCategory->id == $product->sub_category_id ? 'selected' : ''}} value="
                                ...
                                <select id="inputState" class="form-control child-category" name="child_category">
                                    ...
                                    @foreach ($childCategories as $childCategory)
                                        <option {{ $childCategory->id == $product->child_category_id ? 'selected' : ''}} value="
                                            {{ $childCategory->id }}">{{ $childCategory->name }}</option>
                                    @endforeach
                                </select>
                               </div>
                              </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="form-group">
                               ...
                               <div class="form-group">
                                <label>Price</label>
                                <input type="text" class="form-control" name="price" value="{{ $product->offer_price}}">
                              </div>

                              <div class="form-group">
                                <label>Offer Price</label>
                                <input type="text" class="form-control" name="offer_price" value="{{ $product->price}}">
                              </div>
